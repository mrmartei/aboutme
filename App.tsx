  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${isDarkMode ? 'dark bg-zinc-950 text-zinc-50' : 'bg-gray-50 text-zinc-900'}`}>
      ...
      <main className="max-w-6xl mx-auto px-6 pt-32 pb-20">
        ...
        {/* Hero Section */}
        <header className="mb-20 flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12">
          
          {/* Text Content */}
          <div className="flex-1 mt-6 md:mt-0">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500/10 text-orange-600 dark:text-orange-400 text-xs font-bold mb-6 border border-orange-500/20">
            ...
            <p className="text-lg md:text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl mb-8 leading-relaxed">
          ...
          {/* Profile Picture (Completely Blended) */}
          <div className="shrink-0 relative w-full md:w-auto flex justify-center md:justify-end">
             ...
             <div className="relative w-full h-64 md:w-80 md:h-80 overflow-hidden rounded-full md:rounded-none">
                <img 
                  ...
                  onError={(e) => {
                    // Fallback if the signed URL expires
        ...
        {/* Bento Grid Layout */}
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-20 auto-rows-[180px]">
          
          {/* 1. Featured Venture (Large) */}
          <BentoCard className="md:col-span-2 md:row-span-2 relative group" title="Featured Venture" icon={Clapperboard}>
            <VentureCard 
              title="Lumen Studios"
          ...
          <BentoCard className="md:col-span-1 md:row-span-2 flex flex-col" title="Latest Upload" icon={TikTokIcon}>
            <a href="https://www.tiktok.com/@mr.martei/video/7573600817958243597?is_from_webapp=1&sender_device=pc&web_id=7542341471157863942" target="_blank" rel="noopener noreferrer" className="flex-1 rounded-xl bg-zinc-100 dark:bg-zinc-800 overflow-hidden relative group cursor-pointer block">
          ...
          <BentoCard className="md:col-span-1 md:row-span-2" title="Creator Tools" icon={Zap}>
             <div className="flex flex-col gap-4 h-full justify-between py-2">
                {/* Photoshop */}
                <div className="flex items-center gap-3 p-3 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors cursor-default">
                   <div className="w-10 h-10 rounded-lg bg-[#31A8FF]/20 flex items-center justify-center text-[#31A8FF] font-bold">Ps</div>
                   <div>
                     <span className="block font-medium text-zinc-900 dark:text-zinc-200 leading-none">Photoshop</span>
                     <span className="text-xs text-zinc-500">Design</span>
                   </div>
                </div>
                {/* CapCut */}
                <div className="flex items-center gap-3 p-3 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors cursor-default">
                   <div className="w-10 h-10 rounded-lg bg-black/10 dark:bg-white/10 flex items-center justify-center text-zinc-900 dark:text-white font-bold">Cc</div>
                   <div>
                     <span className="block font-medium text-zinc-900 dark:text-zinc-200 leading-none">CapCut</span>
                ...
                <div className="flex items-center gap-3 p-3 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors cursor-default">
                   ...
                   <div>
                     <span className="block font-medium text-zinc-900 dark:text-zinc-200 leading-none">AI Tools</span>
                     <span className="text-xs text-zinc-500">Generation & Ads</span>
                   </div>
                </div>
                {/* Canon */}
                <div className="flex items-center gap-3 p-3 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors cursor-default">
                   ...
                   <div>
                     <span className="block font-medium text-zinc-900 dark:text-zinc-200 leading-none">Canon 6D</span>
          ...
          {/* 4. Services */}
          <BentoCard className="md:col-span-1 md:row-span-1 group cursor-pointer" title="Services" icon={ShoppingBag}>
             <div className="grid grid-cols-2 gap-2 h-full">
                <div className="flex flex-col items-center justify-center gap-2 p-2 rounded-xl bg-zinc-50 dark:bg-zinc-800/30">
                  ...
                  <span className="text-xs font-medium text-zinc-700 dark:text-zinc-200 text-center leading-tight">Graphic Design</span>
                </div>
                <div className="flex flex-col items-center justify-center gap-2 p-2 rounded-xl bg-zinc-50 dark:bg-zinc-800/30">
                  <Code size={20} className="text-blue-500" />
                  <span className="text-xs font-medium text-zinc-700 dark:text-zinc-200 text-center leading-tight">Web Dev</span>
                </div>
                <div className="flex flex-col items-center justify-center gap-2 p-2 rounded-xl bg-zinc-50 dark:bg-zinc-800/30">
                  <Megaphone size={20} className="text-green-500" />
                  <span className="text-xs font-medium text-zinc-700 dark:text-zinc-200 text-center leading-tight">Brand Promo</span>
                </div>
                <div className="flex flex-col items-center justify-center gap-2 p-2 rounded-xl bg-zinc-50 dark:bg-zinc-800/30">
                  <Camera size={20} className="text-purple-500" />
                  <span className="text-xs font-medium text-zinc-700 dark:text-zinc-200 text-center leading-tight">Photo</span>
                </div>
             </div>
          </BentoCard>

           {/* 5. Map / Location */}
           <BentoCard className="md:col-span-1 md:row-span-1" title="HQ Location" icon={MapPin}>
           ...
           <BentoCard className="md:col-span-2 md:row-span-1 group cursor-pointer" title="Get in Touch" icon={Mail}>
              <a href="https://linktr.ee/mr.martei" target="_blank" rel="noopener noreferrer" className="flex items-center gap-6 h-full px-4">
                 <div className="w-12 h-12 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center group-hover:bg-orange-500 group-hover:text-white transition-colors">
                    <ArrowUpRight size={24} />
                 </div>
                 <div>
                    <p className="text-xl font-bold text-zinc-900 dark:text-white group-hover:text-orange-500 transition-colors">Let's Create Together</p>
